...
// Database provider (SqlServer or in-memory Sqlite), selected via the "DatabaseProvider" setting.
...
// Create the schema when running against the in-memory SQLite test database.
